...
public partial class EditorBorrow : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string name= dt.Rows[0][7].ToString();
    ...
    if (int.TryParse(Request.Form[txtcount.UniqueID], out num))
    {
        ...
        string sql = "update tabBorrow set bookname='" + bookname + "' ,writer='" + writer + "',press='" + press + "',number='" + number + "',count='" + count + "',class1='" + class1 + "',name='" + name + "' where id='" + id + "'";
